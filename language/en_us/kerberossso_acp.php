...
$lang = array_merge($lang, array(
	'KERBEROSSSO'							=> 'Web server authenticated single sign-on extension with redundant LDAP servers for lookup and backup bind authentication',
	'KERBEROSSSO_LDAP'						=> 'LDAP Authentication Settings', 
	'KERBEROSSSO_FIELDS'					=> 'LDAP Field Mappings', 
	'KERBEROSSSO_EXTRA'						=> 'Extra Settings for the Extension', 
	...
	'KERBEROSSSO_SERVER1'					=> 'LDAP server name (primary)',
	...
	'KERBEROSSSO_SERVER2'					=> 'LDAP server name (secondary)',
	...
	'KERBEROSSSO_HIDESTATE'      			=> 'Hide state on template',
	'KERBEROSSSO_HIDESTATE_EXPLAIN' 		=> 'If you have users outside the United States, do you want to hide the state field for countries other than the United States?  Or if you only have users in the United States, do you want to hide the country name? <br />When yes, e.g. <samp>Dublin, Ireland</samp> or <samp> Washington, DC</samp>',	
	'KERBEROSSSO_YES' 						=> 'Yes',
	'KERBEROSSSO_NO' 						=> 'No',
